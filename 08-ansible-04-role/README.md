...
Ссылка на репозиторий с playbook: https://github.com/gdmitriyv/mnt-homeworks/tree/MNT-video/08-ansible-04-role

Ссылка на репозиторий lighthouse-role: https://github.com/gdmitriyv/lighthouse-role 

Ссылка на репозиторий vector-role: https://github.com/gdmitriyv/vector-role